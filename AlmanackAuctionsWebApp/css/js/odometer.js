...
(function () {
  var a,
    ...
    F,
    G = [].slice;
  (r = '<span class="odometer-value"></span>'),
    (o =
    ...
    (n = (function () {
      function a(b) {
        ...
        null == (h = this.options).duration && (h.duration = f),
          (this.MAX_VALUES = (this.options.duration / l / j) | 0),
          this.resetFormat(),
        ...
        try {
          for (
            o = ["innerHTML", "innerText", "textContent"], i = 0, k = o.length;
            k > i;
            i++
          )
            (e = o[i]),
      ...
      return (
        ...
        (a.prototype.resetFormat = function () {
          ...
          if (
            ((a = null != (k = this.options.format) ? k : c),
            a || (a = "d"),
            (f = h.exec(a)),
            !f)
          )
          ...
          return (
            ...
            (d = l[2]),
            (e = l[3]),
            (b = (null != d ? d.length : void 0) || 0),
            (g = b + (null != e ? e.length : void 0) || 0),
            (this.format = {
              repeating: j,
              radix: i,
              precision: g,
        ...
        (a.prototype.render = function (a) {
          ...
          return (
            e.push("odometer"),
            q || e.push("odometer-no-transitions"),
        ...
        (a.prototype.formatDigits = function (a) {
          ...
          if (((this.digits = []), this.options.formatFunction))
            for (
              h = this.options.formatFunction(a),
                m = h.split("").reverse(),
                i = 0,
                l = m.length;
              l > i;
              ...
              (g = m[i]),
                g.match(/[0-9]/)
                  ? ((b = this.renderDigit()),
                    (b.querySelector(".odometer-value").innerHTML = g),
                    this.digits.push(b),
                    this.insertDigit(b))
                  : this.addSpacer(g);
          else {
            for (
              f = Math.abs(a),
                c = Math.max(
                  ...
                  this.getFractionalDigitCount(f)
                ),
                c && (f *= Math.pow(10, c)),
                d = 0;
              f > 0;
              ...
              this.addDigit((f % 10).toString(), d >= c),
                (f = Math.floor(f / 10)),
                (d += 1),
                d === c && this.addDigit(".", !0);
            for (
              e = null != (n = this.options.minIntegerLen) ? n : k,
                d = j = o = d - c;
              e > j;
              d = j += 1
            )
          ...
          return (
            ...
            (b = a - this.value)
              ? (v(
                ...
                b > 0
                  ? s(this.el, "odometer-animating-up")
                  : s(this.el, "odometer-animating-down"),
                this.stopWatchingMutations(),
                this.animate(a),
                this.startWatchingMutations(),
                setTimeout(function () {
        ...
        (a.prototype.addSpacer = function (a, b, c) {
          var d;
          return (
            (d = t(g)), (d.innerHTML = a), c && s(d, c), this.insertDigit(d, b)
          );
        }),
        ...
        (a.prototype.animate = function (a) {
          return q && "count" !== this.options.animation
            ? this.animateSlide(a)
            : this.animateCount(a);
        }),
        ...
        (a.prototype.animateSlide = function (a) {
          ...
          if (
            ...
            (j = Math.max(
              this.format.fractional,
              this.getFractionalDigitCount(u, a)
            )),
            j && ((a *= Math.pow(10, j)), (u *= Math.pow(10, j))),
            (d = a - u))
          ) {
            for (
              this.bindTransitionEnd(),
                r = null != (F = this.options.minIntegerLen) ? F : k,
                f = Math.max(this.getDigitCount(u, a), r + j),
                g = [],
                b = 0,
                n = x = 0;
              f >= 0 ? f > x : x > f;
              ...
              if (
                ((v = A(u / Math.pow(10, f - n - 1))),
                (i = A(a / Math.pow(10, f - n - 1))),
                (h = i - v),
                Math.abs(h) > this.MAX_VALUES)
              ) {
                for (
                  m = [],
                    o = h / (this.MAX_VALUES + this.MAX_VALUES * b * e),
                    c = v;
                  (h > 0 && i > c) || (0 > h && c > i);
                ...
                m = function () {
                  H = [];
                  for (var a = v; i >= v ? i >= a : a >= i; i >= v ? a++ : a--)
                    H.push(a);
                  return H;
                }.apply(this);
            ...
            for (
              this.resetDigits(), G = g.reverse(), n = z = 0, C = G.length;
              C > z;
              n = ++z
            )
              for (
                m = G[n],
                  this.digits[n] || this.addDigit(" ", n >= j),
                  null == (w = this.ribbons)[n] &&
                    (w[n] = this.digits[n].querySelector(
                      ".odometer-ribbon-inner"
                    )),
                  this.ribbons[n].innerHTML = "",
                  0 > d && (m = m.reverse()),
                  p = E = 0,
                  D = m.length;
                D > E;
                ...
                (l = m[p]),
                  ...
                  (t.className = "odometer-value"),
                  (t.innerHTML = l),
                  this.ribbons[n].appendChild(t),
                  p === m.length - 1 && s(t, "odometer-last-value"),
                  0 === p && s(t, "odometer-first-value");
            return (
              0 > v && this.addDigit("-"),
              (q = this.inside.querySelector(".odometer-radix-mark")),
              null != q && q.parent.removeChild(q),
              j
                ? this.addSpacer(
                    this.format.radix,
                    this.digits[j - 1],
    ...
    (n.options = null != (E = window.odometerOptions) ? E : {}),
    setTimeout(function () {
      var a, b, c, d, e;
      if (window.odometerOptions) {
        ...
        for (a in d)
          (b = d[a]),
            e.push(
              null != (c = n.options)[a] ? (c = n.options)[a] : (c[a] = b)
            );
        return e;
      }
    }, 0),
    (n.init = function () {
      ...
      if (null != document.querySelectorAll) {
        for (
          b = document.querySelectorAll(n.options.selector || ".odometer"),
            f = [],
            c = 0,
            d = b.length;
          d > c;
