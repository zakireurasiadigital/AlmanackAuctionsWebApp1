<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AlmanackAuctionsWebApp.UserManagement.Default" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="add-user-tab" data-bs-toggle="tab" href="form.aspx?i=0&t=0" role="tab" aria-controls="add-user" aria-selected="false">Add Admin Agent User</a>
                </li>
            </ul>
        </div>
        <div align="center">
            <asp:GridView PageSize="50" ID="gvMain" HeaderStyle-BackColor="SeaGreen" OnSorting="gvMain_Sorting" HeaderStyle-HorizontalAlign="Center" OnPageIndexChanging="gvMain_PageIndexChanging" HeaderStyle-ForeColor="White" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="UserID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnEdit" PostBackUrl='<%# Eval("UserID", "~/UserManagement/FormEdit.aspx?i={0}") %>' runat="server">
                    <i class="fas fa-pencil-alt" style="color: seagreen;" title="Click here to edit" ></i>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="btnChangePassword" PostBackUrl='<%# Eval("UserID", "~/UserManagement/ChangePassword.aspx?i={0}&UserType=Superadmin") %>' runat="server">
